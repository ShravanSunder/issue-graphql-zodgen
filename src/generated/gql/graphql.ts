...
export type CommentFieldsFragment = {
  ...
  stats: { __typename?: "PublicationStats" } & {
    " $fragmentRefs"?: { StatsFieldsFragment: StatsFieldsFragment };
  };
  metadata: { __typename?: "MetadataOutput" } & {
    " $fragmentRefs"?: { MetadataFieldsFragment: MetadataFieldsFragment };
  };
  commentOn?:
    | {
        __typename?: "Comment";
        ...
        collectedBy?: {
          __typename?: "Wallet";
          address: string;
          defaultProfile?: { __typename?: "Profile"; handle: string } | null;
        } | null;
        collectModule:
          | ({ __typename?: "FeeCollectModuleSettings" } & {
              " $fragmentRefs"?: {
...
export type MetadataFieldsFragment = {
  ...
  cover?: {
    __typename?: "MediaSet";
    original: { __typename?: "Media"; url: string };
  } | null;
  media: Array<{
    __typename?: "MediaSet";
    original: { __typename?: "Media"; url: string; mimeType?: string | null };
  }>;
} & { " $fragmentName"?: "MetadataFieldsFragment" };
...
export type ProfileFieldsFragment = {
  ...
  picture?:
    ...
    | { __typename?: "NftImage"; uri: string }
    | null;
  followModule?:
    | { __typename: "FeeFollowModuleSettings" }
    | { __typename: "ProfileFollowModuleSettings" }
...
type RelayerResultFields_RelayError_Fragment = {
  __typename?: "RelayError";
  reason: RelayErrorReasons;
} & { " $fragmentName"?: "RelayerResultFields_RelayError_Fragment" };

type RelayerResultFields_RelayerResult_Fragment = {
  __typename?: "RelayerResult";
  txHash: string;
  txId: string;
} & { " $fragmentName"?: "RelayerResultFields_RelayerResult_Fragment" };
...
} & { " $fragmentName"?: "StatsFieldsFragment" };
...
export type BroadcastMutation = {
  ...
  broadcast:
    ...
    | { __typename?: "RelayerResult"; txHash: string; txId: string };
};
...
export type CreateCommentViaDispatcherMutation = {
  ...
  createCommentViaDispatcher:
    | ({ __typename?: "RelayError" } & {
        " $fragmentRefs"?: {
          RelayerResultFields_RelayError_Fragment: RelayerResultFields_RelayError_Fragment;
        };
      })
    | ({ __typename?: "RelayerResult" } & {
        " $fragmentRefs"?: {
          RelayerResultFields_RelayerResult_Fragment: RelayerResultFields_RelayerResult_Fragment;
        };
      });
};
...
export type CollectorsQuery = {
  ...
  whoCollectedPublication: {
    ...
    items: Array<{
      ...
      address: string;
      defaultProfile?:
        | ({ __typename?: "Profile"; isFollowedByMe: boolean } & {
            " $fragmentRefs"?: { ProfileFieldsFragment: ProfileFieldsFragment };
          })
        | null;
    }>;
    ...
    items: Array<{
      ...
      wallet: {
        ...
        defaultProfile?:
          | ({ __typename?: "Profile"; isFollowedByMe: boolean } & {
              " $fragmentRefs"?: {
                ProfileFieldsFragment: ProfileFieldsFragment;
              };
            })
          | null;
      };
...
export type FollowingQuery = {
  ...
  following: {
    ...
    items: Array<{
      ...
      profile: { __typename?: "Profile"; isFollowedByMe: boolean } & {
        " $fragmentRefs"?: { ProfileFieldsFragment: ProfileFieldsFragment };
      };
    }>;
    pageInfo: {
...
export type ProfileAddressQuery = {
  __typename?: "Query";
  profile?: { __typename?: "Profile"; id: string; ownedBy: string } | null;
};
  ...
  search:
    ...
    | {
        ...
        items: Array<
          | ({ __typename?: "Comment" } & {
              " $fragmentRefs"?: {
                CommentFieldsFragment: CommentFieldsFragment;
              };
            })
          | ({ __typename?: "Post" } & {
              " $fragmentRefs"?: { PostFieldsFragment: PostFieldsFragment };
...
export type UserProfilesQueryVariables = Exact<{
  ownedBy?: InputMaybe<
    Array<Scalars["EthereumAddress"]> | Scalars["EthereumAddress"]
  >;
}>;
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "hasCollectedByMe" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "collectedBy" },
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CreateSetDefaultProfileRequest" },
            },
          },
        },
      ],
                          ...
                          selections: [
                            {
                              ...
                              name: {
                                kind: "Name",
                                value: "SetDefaultProfileWithSig",
                              },
                              selectionSet: {
                                kind: "SelectionSet",
                                selections: [
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "moduleName" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "contractAddress" },
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "FeedHighlightsRequest" },
            },
          },
        },
        {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      },
                      {
                        ...
                        name: {
                          kind: "Name",
                          value: "totalAmountOfTimesFollowed",
                        },
                      },
                    ],
                  },
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "FollowingRequest" },
            },
          },
        },
      ],
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      },
                      {
                        ...
                        name: {
                          kind: "Name",
                          value: "totalAmountOfTimesFollowing",
                        },
                      },
                    ],
                  },
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "onChainContentURI" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "collectNftAddress" },
      ...
      variableDefinitions: [
        {
          ...
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "RecommendedProfileOptions" },
          },
        },
      ],
      selectionSet: {
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "AllPublicationsTagsRequest" },
            },
          },
        },
      ],
